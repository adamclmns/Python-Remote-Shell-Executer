...
'''
Imporing third party modules. Installed via "pip install fabric"
'''
...
'''
these are all standard modules included with python 2.7
'''
import os, time, datetime, Tkinter as tk, tkFileDialog, argparse, ConfigParser
from getpass import getpass

'''
Pulling the configuration file that was generated by executing config.py
'''
...
def deploySh(filepath=ScriptPath):
    ...
    '''
    # split file name and path into seperate strings
    # This is from a stackoverflow post.
    path, filename=os.path.split(filepath)
    # ask the user for a password, or use a provided default. 
    authorize()
    # uploads the .sh
    put(filepath, '~/'+filename, mode=0775)
    # collect the output of executing the script.
    out = run('~/'+filename)
    # write the output
...
if __name__=='__main__':
    '''
    Python conceptual equiv. of java's "public static void main()"
    '''
    #Command line params, because the UI isn't stable yet
    ...
    # Parse arguments that were provided
    ...
    # With the settings for hidding output, execute the deploySh function. 
    with hide('output'):
        execute(deploySh)
